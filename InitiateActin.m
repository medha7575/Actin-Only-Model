...
for i=1:NPFCount
    ...
    Ac_Node(Ac_NodeCount,BRANCHORNOT)= 0; % zero at this position represents unbranched
    ...
    Ac_Node(Ac_NodeCount,MCSATBIRTH)= 0;  % Simulation step of creation like date of birth
